...
<h1>Lançamento de Mensalidade</h1>
<br><br>
<form name = "signup" method= "post" action="lancaf.php">
	...
	Valor: <input type ="text"  required="required" name="valor"/><br><br>
	Data: <input type ="date" required="required" name="datap"/><br><br>
	
	Mês de Referência: <input type='month' required="required" name= 'referencia'>	
	 
   
					<br><br>
	<input type="submit" id="botao1" name= 'salvar' value="Lançar"/>
