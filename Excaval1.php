...
<h1>Excluir de Avaliação</h1>
<br><br>
<form name = "signup" method= "post" action="Excaval.php">
	
	Mês de Referência:<input type='month'  required="required" name="data"/><br><br>
	
	 
   
					<br><br>
	<input type="submit" id="botao1" name= 'excluir' value="OK"/>
